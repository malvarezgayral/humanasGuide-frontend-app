...
import { TextField, Autocomplete, Button, FilledTextFieldProps, OutlinedTextFieldProps, StandardTextFieldProps, TextFieldVariants } from "@mui/material";
...
export const SearchDataTable = () => {
  ...
  // Opciones estáticas (pueden venir de una API)
  const subjectOptions = ["Matemática", "Física", "Química"]; // Ejemplo
  const typeOptions = ["EXAMEN", "RESUMEN", "PARCIAL"]; // Ejemplo
